            ...
            <div className="modal-content">
              ...
              <div className="modal-body px-4 py-3" style={{ fontSize: '0.9rem' }}>
                <p className="text-muted">
                  ...
                  Tecnológica núm. 34, Fracc. Universidad, C.P. 37800, Dolores Hidalgo, Gto., es el
                ...
                <ul className="mb-2">
                  ...
                  <li>
                    Procesamiento y seguimiento de proyectos socioproductivos, tecnológicos o de la
                    Incubadora de Empresas de la UTNG.
                  </li>
                ...
                <div className="alert alert-warning py-2 small">
                  ...
                  enviando un correo a <a href="mailto:gaelq1074@gmail.com">gaelq1074@gmail.com</a>{' '}
                  o ante la Unidad de Transparencia.
                </div>
                ...
                <p>
                  ...
                  cuando sea necesario para el ejercicio de sus facultades, o a entidades vinculadas
                  al servicio educativo y tecnológico de la UTNG.
                </p>
                ...
                <p className="mb-1">
                  Puede presentar solicitudes de Acceso, Rectificación, Cancelación u Oposición ante
